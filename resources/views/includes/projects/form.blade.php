...
<div class="mb-3">
    ...
    <textarea class="form-control" id="web_platform" rows="3" name="web_platform">{{ $project->web_platform }}</textarea>
</div>
<div class="col-6">
    <label for="project_for" class="form-label">Project_for</label>
    <input type="text" class="form-control" id="project_for" name="project_for" value="{{ $project->project_for }}">
</div>
<div class="col-6">
